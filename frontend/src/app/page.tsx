...
import PortfolioTab from '@/components/PortfolioTab'; // NEW
...
export default function Home() {
  ...
  const [mainTab, setMainTab] = useState<'chart' | 'fundamentals' | 'portfolio'>('chart');
      ...
      <div className="relative z-10 container mx-auto px-4 py-12">
        ...
        <div className="flex justify-center gap-4 mb-8">
          <button
            ...
            className={`px-6 py-3 rounded-xl font-bold text-lg transition-all border ${mainTab !== 'portfolio'
                ? 'bg-blue-600/20 border-blue-500/50 text-blue-400 shadow-[0_0_20px_rgba(37,99,235,0.3)]'
          ...
          <button
            ...
            className={`px-6 py-3 rounded-xl font-bold text-lg transition-all border ${mainTab === 'portfolio'
                ? 'bg-purple-600/20 border-purple-500/50 text-purple-400 shadow-[0_0_20px_rgba(147,51,234,0.3)]'
                : 'bg-slate-800/50 border-slate-700/50 text-slate-500 hover:text-slate-300'
              }`}
          >
            💼 My Portfolios
        ...
        {/* Portfolio View */}
        {mainTab === 'portfolio' ? (
          <div className="max-w-7xl mx-auto animate-fade-in bg-white/5 rounded-2xl p-1 backdrop-blur-md border border-white/10">
            <PortfolioTab />
          </div>
        ) : (
          /* Stock Analysis View */
